...
#define   PCI_DEVICE_ID_8XXX_VNIC_PF	    	0xA01E
#define   PCI_DEVICE_ID_8XXX_VNIC_VF	    	0x0011
#define   PCI_DEVICE_ID_8XXX_BGX	    	0xA026

#define   PCI_CFG_REG_BAR_NUM			0
#define   PCI_MSIX_REG_BAR_NUM			4

/* Physical function registers */
#define   NIC_BASE_ADDR				0x843000000000
...
#define   NIC_VNIC_0_127_CFG			(0x000020)
#define   NIC_VF_0_127_PF_MAILBOX_0_7		(0x000100) /* + (0..127) << 21 + (0..7) << 3*/
#define   NIC_VF_0_127_INT			(0x000200) /* + (0..127) << 21 */ 
#define   NIC_VF_0_127_INT_W1S			(0x000220)
#define   NIC_VF_0_127_ENA_W1C			(0x000240)
#define   NIC_VF_0_127_ENA_W1S			(0x000260)

#define   NIC_VNIC_0_127_RSS_CFG		(0x0020E0)
#define   NIC_VNIC_0_127_RSS_KEY_0_4		(0x002200) /* + (0..127) << 21 + (0..4) << 3*/
#define   NIC_VNIC_0_127_TX_STAT_0_5		(0x004000)
#define   NIC_VNIC_0_127_RX_STAT_0_13		(0x004100)

#define   NIC_QSET_0_127_CQ_0_7_CFG		(0x010400)
#define   NIC_QSET_0_127_CQ_0_7_CFG2		(0x010408)
#define   NIC_QSET_0_127_CQ_0_7_THRESH		(0x010410)
#define   NIC_QSET_0_127_CQ_0_7_BASE		(0x010420)
#define   NIC_QSET_0_127_CQ_0_7_HEAD		(0x010428)
#define   NIC_QSET_0_127_CQ_0_7_TAIL		(0x010430)
#define   NIC_QSET_0_127_CQ_0_7_DOOR		(0x010438)
#define   NIC_QSET_0_127_CQ_0_7_STATUS		(0x010440)
#define   NIC_QSET_0_127_CQ_0_7_STATUS2 	(0x010448)
#define   NIC_QSET_0_127_CQ_0_7_DEBUG		(0x010450)

#define   NIC_QSET_0_127_RQ_GEN_CFG		(0x010010)
#define   NIC_QSET_0_127_RQ_0_7_CFG		(0x010600)
#define   NIC_QSET_0_127_RQ_0_7_STAT_0_1	(0x010700)

#define   NIC_QSET_0_127_SQ_0_7_CFG		(0x010800)
#define   NIC_QSET_0_127_SQ_0_7_THRESH		(0x010810)
#define   NIC_QSET_0_127_SQ_0_7_BASE		(0x010820)
#define   NIC_QSET_0_127_SQ_0_7_HEAD		(0x010828)
#define   NIC_QSET_0_127_SQ_0_7_TAIL		(0x010830)
#define   NIC_QSET_0_127_SQ_0_7_DOOR		(0x010838)
#define   NIC_QSET_0_127_SQ_0_7_STATUS		(0x010840)
#define   NIC_QSET_0_127_SQ_0_7_DEBUG		(0x010848)
#define   NIC_QSET_0_127_SQ_0_7_CNM_CHG		(0x010860)
#define   NIC_QSET_0_127_SQ_0_7_STAT_0_1	(0x010900)

#define   NIC_QSET_0_127_RBDR_0_1_CFG		(0x010C00)
#define   NIC_QSET_0_127_RBDR_0_1_THRESH	(0x010C10)
#define   NIC_QSET_0_127_RBDR_0_1_BASE		(0x010C20)
#define   NIC_QSET_0_127_RBDR_0_1_HEAD		(0x010C28)
#define   NIC_QSET_0_127_RBDR_0_1_TAIL		(0x010C30)
#define   NIC_QSET_0_127_RBDR_0_1_DOOR		(0x010C38)
#define   NIC_QSET_0_127_RBDR_0_1_STATUS0	(0x010C40)
#define   NIC_QSET_0_127_RBDR_0_1_STATUS1	(0x010C48)

#define   NIC_VF_0_127_MSIX_VECTOR_0_18_ADDR	(0x000000)
#define   NIC_VF_0_127_MSIX_VECTOR_0_18_CTL	(0x000008)
#define   NIC_VF_0_127_MSIX_PBA 		(0x010000)

/* Offsets within registers */
#define   VNIC_MSIX_VEC_SHIFT	4
#define   VNIC_Q_NUM_SHIFT	18
#define   VNIC_QS_ID_SHIFT	21
#define   VNIC_VF_NUM_SHIFT	21

/* Virtual function's register access APIs */
